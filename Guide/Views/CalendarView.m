...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
//        _bgView = [[UIView alloc]initWithFrame:CGRectMake(frame.size.width/8, 0, 200, 20)];
//        _bgView.backgroundColor = RGBCOLOR(255, 88, 88);
//        [self addSubview:_bgView];
        ...
        //设置需要表示哪些信息（NSYearCalendarUnit, NSMonthCalendarUnit, NSDayCalendarUnit等）
...
-(id)init
{
    self = [self initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 250)];
    if (self)
    {
