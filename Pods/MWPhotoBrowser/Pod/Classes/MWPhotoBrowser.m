...
- (void)deletePhoto:(UIButton *)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(photoBrowser: deletePhoto:)]) {
        
        [self.delegate photoBrowser:self deletePhoto:_currentPageIndex];
